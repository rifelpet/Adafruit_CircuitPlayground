...
#define NOT_AN_INTERRUPT -1
  ...
  #define CPLAY_REDLED 13
  #define CPLAY_NEOPIXELPIN 30
  #define CPLAY_SLIDESWITCHPIN A2
  #define CPLAY_LEFTBUTTON 27
  #define CPLAY_RIGHTBUTTON 12
  #define CPLAY_LIGHTSENSOR A5
  #define CPLAY_LIS3DH_CS 38
  #define CPLAY_THERMISTORPIN A17
  #define CPLAY_SOUNDSENSOR A16
  #define CPLAY_BUZZER A0
  #define CPLAY_CAPSENSE_SHARED 31
#endif
